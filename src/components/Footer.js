...
const Footer = () => {
    return (
        <React.Fragment>
            <div className="grid grid-cols-2 py-10 font-jura text-2xl">
                <div className="flex flex-col items-center">
                    <header className="text-3xl font-lalezar">Contact</header>
                ...
                <div className="flex flex-col items-center">
                    <header className="text-3xl font-lalezar">Connect</header>
                    ...
                    <a href="https://www.twitter.com/dwayne_devs" rel="noreferrer" target="_blank" className="flex items-center text-neon-pink hover:text-neon-teal">
                        <RiTwitterLine size={36} />
                        Twitter
                    </a>
                </div>
            </div>
            <p className="w-full text-neon-pink text-center font-jura text-2xl mb-3">Made with &#9829; by Dwayne Rill Jr. <br /> Copyright &copy; 2021 Dwayne Rill Jr.</p>
        </React.Fragment>
    )
}
