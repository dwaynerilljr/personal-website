...
export default function Nav() {
    ...
    return (
        <React.Fragment>
            <nav className={navbar ? "transition ease-in duration-300 bg-neon-teal flex text-default-black text-2xl font-jura fixed w-screen" : "transition ease-in duration-300 bg-transparent flex text-neon-teal text-2xl font-jura fixed w-screen"}>
